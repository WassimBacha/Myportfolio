  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        name: "TensorFlow",
        image:
          "https://upload.wikimedia.org/wikipedia/commons/thumb/1/11/TensorFlowLogo.svg/1280px-TensorFlowLogo.svg.png",
      },
      {
        name: "scikit-learn",
        image:
...
export const experiences = [
  {
    ...
    desc: "Working on a platform that manages company employees and there tasks .",
    skills: [
      "Python",
      "Flask",
      "Mysql",
  ...
  },
  {
    ...
    desc: "Working on a desktop application to manage packages.",
    skills: [
      "Intellij",
      "Javafx",
      "Mysql",
